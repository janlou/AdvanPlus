...
if msg_valid(msg) then
	var_cb(msg, msg)
	--[[Security:]]
	if msg.to.type == "channel" and not redis:sismember("BotHaveRankMembers", msg.sender_user_id_) and not redis:sismember("BotHaveRankMembers(Group)"..msg.chat_id_, msg.sender_user_id_) and not redis:sismember("AllowUserFrom~"..msg.chat_id_, msg.sender_user_id_) then
